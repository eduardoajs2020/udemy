        ...
        <div id="main-container" class="container-fluid">
          <div class="col-md-12">
            <form action="<?=$BASE_URL?>user_process.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="row"><!--coloca uma coluna debaixo da outra-->
                    <div class="col-md-4">
                        <h1><?=$fullName?></h1>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                           ...
                           <textarea class="form-control" name="bio" id="bio" rows="5" placeholder="Conte-nos quem é você, o que faz e onde trabalha..."><?=$userData->bio?></textarea>
                        </div>
                    </div>
                </div>
            </form>
